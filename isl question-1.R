...
## D Sai Suma is my computer name#####

College<-read.csv("C:\\Users\\D Sai suma\\OneDrive\\Documents\\isl\\College.csv", header= TRUE)
View(College)
...
Boston<-read.csv("C:\\Users\\D Sai suma\\OneDrive\\Documents\\isl\\Boston.csv", header= TRUE, na.strings = "?")
head(Boston)
